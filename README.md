...
![final expected image](img/final.png)
...
![Initial create react app demo screen](img/base_cra_screen.png)
...
![Initial red container card](img/initial_container.png)
...
![bad classname handing](img/bad_classname.png)
...
![className correctly applied](img/correct_classname.png)
...
![final perfect image](img/final.png)

Conclusion
----------
I hope this article is useful in outlining some of the best
practices required for creating flexible and modular React
components. Please do shout out to **srinathh-at-gmail** in 
case of any errors, comments or suggestions.
